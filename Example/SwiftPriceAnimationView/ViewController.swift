...
import UIKit
import SwiftPriceAnimationView
...
class ViewController: UIViewController {
    ...
    var testView: SwiftPriceAnimationView?
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        testView = SwiftPriceAnimationView.init(.boldSystemFont(ofSize: 36.0), .black, .systemPink, 36.0, 2000000, 1000, 0.08, 0.10, 0.30)
...
extension ViewController: SwiftPriceAnimationViewDelegate {
    func IsPriceOverMaximumPrice(isOverMaximumPrice: Bool) {
        print("call maximum delegate")
    }
    
    func IsPriceOverMinimumPrice(isOverMinimumPrice: Bool) {
        print("call minimum delegate")
    }
}
